<?php
  ...
  ****************************************************************************/
  ...
  $text = $tag->addText(86, 25, "<*font=bold*>Montana State\nUniversity", "", 10, 0x000000);
  $text->setAlignment(Center);
  
  $text = $tag->addText(7, 35, "Data for ".$data["date"]." ".$data["time"], "", 8, 0x000000);
  $text->setAlignment(TopLeft);
  ...
  if ($aurora_status[5] != 0) {
  	$text = $tag->addText(25, 60, "".$brightness[$aurora_status[5]]." Aurora\nDuration: "."1"." hr, "."30"." min", "", 10, 0x000000);
  } else {
  	$text = $tag->addText(25, 60, "".$brightness[$aurora_status[5]],"", 10, 0x000000);
  }
  $text->setAlignment(TopLeft);
