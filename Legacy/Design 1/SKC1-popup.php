<?php
  ...
  ****************************************************************************/
  ...
  $text = $tag->addText(86, 25, "<*font=bold*>Salish Kootenai\nCollege", "", 10, 0x000000);
  ...
  if ($aurora_status[0] != 0) {
  	$text = $tag->addText(25, 60, "".$brightness[$aurora_status[0]]." Aurora\nDuration: "."1"." hr, "."30"." min", "", 10, 0x000000);
  } else {
  	$text = $tag->addText(25, 60, "".$brightness[$aurora_status[0]],"", 10, 0x000000);
  }
  $text->setAlignment(TopLeft);
