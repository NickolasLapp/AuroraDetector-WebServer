...
function loadKml(file) {
	...
	if (file == 'full') {
		...
		var kmlUrl = 'http://192.168.137.2/aurora/AuroraNetwork_Web.php?time='+ts;
	} else if (file == 'abbrev') {
		var kmlUrl = 'http://192.168.137.2/aurora/AuroraNetwork_Web-Abbreviated.php?time='+ts;
	} else if (file == 'oval') {
		//TODO: Figure out why the local file doesn't work!
		var kmlUrl = 'http://192.168.137.2/aurora/AuroraNetwork_Web-NOAAAuroralOval.kml'
	}
	// fetch the KML
